...
(function(){
  ...
  ready(function(){
    var css = ''
      ...
      +   '#overlay .mega-chev{display:flex;align-items:center;justify-content:center;flex:none;width:14px;height:14px;position:relative;background:none;border:0;padding:12px;margin:-12px;cursor:pointer}'
      ...
      +   '.st-foot__cols .ft-chev{display:flex;align-items:center;justify-content:center;flex:none;width:14px;height:14px;position:relative;padding:12px;margin:-12px}'
